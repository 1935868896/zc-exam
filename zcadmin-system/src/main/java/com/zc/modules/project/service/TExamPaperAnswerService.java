 ...
 * @date 2021-09-18
 */
public interface TExamPaperAnswerService extends IService<TExamPaperAnswer> {
    /**
     * 查询答案信息
     *
     * @param id 答案ID
    ...
    PaperAnswerReadVO selectReadRecord(Integer id);

    AnswerAnalysisVO answerAnalysis(AnswerInfo record);
     ...
     * @return 修改数量
     */
    int updateBatchBySelective(List<TExamPaperAnswer> recordList);
